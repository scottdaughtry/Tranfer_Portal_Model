        ...
        fluidRow(
          column(
            ...
            selectInput(
              ...
              choices = c(
                "Right Block", "Rim Shots", "Left Block", "Right Short Corner", "Left Short Corner",
...
server <- function(input, output) {
  ...
  output$boxstats <- renderDT({
    ...
    lucas_table <- lucas_table %>% select(
      "Player Name", "First School Name", "Position", "Height", "Year", "Games Started", "PPG", "RebPG",
